...
export const it: Dictionary = {
  ...
  settings: {
    ...
    peopleHint: 'Questo lo vedono solo i telefoni tuoi. Chi fai entrare può parlare con chiunque: la persona dall\'altra parte del suo collegamento non deve chiedere niente - il suo telefono entra accanto al suo, per quel collegamento soltanto, e non può aprirne uno suo.',
    personSince: 'dal {date}',
    personRooms: '{n} collegamenti, {guests} con qualcuno al seguito',
    forgetPerson: 'togli',

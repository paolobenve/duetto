...
export const it: Dictionary = {
  ...
  welcome: {
    ...
    acceptHint: 'Otto cifre sono un collegamento; quattro lettere, un trattino e altre quattro sono un invito a un server.',
  ...
  pairing: {
    ...
    haveCodeInstead: 'Oppure scrivi il codice del proprietario',

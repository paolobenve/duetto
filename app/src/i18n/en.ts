...
export const en = {
  ...
  settings: {
    ...
    peopleHint: 'Only phones of yours can see this. Whoever you let in can talk to anybody: the person on the other side of their connection has nothing to ask - their phone is let in beside theirs, for that connection alone, and cannot open one of its own.',
    personSince: 'since {date}',
    personRooms: '{n} connection(s), {guests} with somebody along',

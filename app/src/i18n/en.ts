...
export const en = {
  ...
  pairing: {
    ...
    copied: 'Copied',
    share: 'Share',
    toWorkItem: 'to the work item',
    inviteSent: 'The link is on {name}\'s work item, which is now confidential.',
    inviteNoWorkItem: 'No open work item with "{name}" in its title.',

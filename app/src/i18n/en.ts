...
export const en = {
  ...
  settings: {
    ...
    screen: 'Screen',
    showTechnical: 'Show the technical details',
    showTechnicalNote: 'Under the buttons: resolution, frames, bandwidth and which way the link goes. They are there to explain why a call is going badly.',

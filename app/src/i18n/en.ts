...
export const en = {
  ...
  settings: {
    ...
    delayTotalOnlyNote: 'One number instead of two: what one lives through talking, without the half that says on which of the two phones it sits.',

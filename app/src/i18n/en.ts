...
export const en = {
  ...
  errors: {
    ...
    takenRoom: 'This pair is not yours',
    takenRoomBody: 'The code opens a room that belongs to two other phones. Check the code, or have a new one made.',
    nameTaken: 'Somebody on the list already has this name: choose another.',
  ...
  presence: {
    ...
    withPeer: 'In the channel{channel} with {who}',
    peerInChannel: '{ours} · {who} is in the channel{when}',
    peerWaiting: '{ours} · {who} waiting{when}',
    peerWaitingTornDown: '{ours} · {who} waiting{when} (app closed by the phone)',
    peerDetached: '{ours} · {who} switched Duetto off{when}',
    peerUnreachable: '{ours} · {who} is unreachable{when}',
    sinceTime: ' since {time}',
    atTime: ' at {time}',
    bothWaitingSince: 'Both waiting{channel}: you{mine}, {who}{theirs}',
    withPeerSince: 'In the channel{channel}: you{mine}, {who}{theirs}',
    channelName: ' {name}',
    inTheChannel: ' in the channel {name}',
  },
  ...
  channel: {
    ...
    lossTitle: 'The voice comes choppy',
    lossBody: 'The network is losing packets in this direction. Shorter packets lose less of the voice each time one goes missing; they cost a little more battery. The choice holds for both phones.',
    loss_always: 'Turn on, always',
    loss_once: 'Turn on for this time',
    loss_later: 'Not now',
    loss_never: 'No, and do not ask me again',
    lossHint: 'The option stays in the settings, Diagnostics tab, under "Short packets".',
    speakerNoticeTitle: 'The speaker, from now on?',
    ...
    batteryBoth: 'battery: you {mine} · the other {theirs}',
    batteryMine: 'battery: you {mine}',
    batteryTheirsOnly: 'battery: the other {theirs}',
    ...
    detachConfirm: 'Become unavailable?',
    ...
    outputOff: 'Hush the other person',
    outputOn: 'Sound back on',
    theOther: 'The other person',
    peerIsWaiting: '{who} is waiting',
    peerMadeUnreachable: '{who} switched Duetto off',
    peerUnreachable: '{who} is unreachable',
    connecting: 'connecting…',
    noServer: 'no server',
    here: 'here',
    disconnected: 'switched Duetto off',
    waiting: 'waiting',
  ...
  settings: {
    ...
    outputOnEntry: 'Sound on entering',
    outputOnEntryEar: 'In the earpiece',
    outputOnEntryEarNote: 'Every entry starts in the earpiece, as a call does; the speaker is yours to choose each time.',
    outputOnEntryAsLeft: 'As it was left',
    outputOnEntryAsLeftNote: 'Each connection remembers its output - speaker, earpiece, headset - and comes back to it.',
    cueVolume: 'Volume of the cues',
    cueVolumeNote: 'The short sounds of video, microphone, camera, coming in and going out, heard by both. Touch to hear it.',
    cueOff: 'Off',
    cueVeryLow: 'Very low',
    cueLow: 'Low',
    cueMedium: 'Medium',
    ...
    cannotAddHere: 'This server lets you talk to whoever let you in: a code is theirs to make, not yours. What somebody hands you - an invitation, or a connection made on their phone - you can accept here.',
    ...
    earOnProximity: 'To the ear, to the earpiece',
    ...
    soundChosenNote: 'A sound taken from the phone.',
    soundChoose: 'Choose a sound from the phone…',
    soundChooseAnother: 'Choose another sound from the phone…',
    soundChooseNote: 'A sound unlike the others tells you who it is without looking.',
    soundDuetto: 'One of Duetto\'s sounds',
    soundDuettoNote: 'One of Duetto\'s five sounds.',
    soundDuettoChoose: 'Choose one of Duetto\'s sounds…',
    soundDuettoHint: 'Touch one to hear it: it becomes the sound this phone alerts you with.',
    ...
    shortPackets: 'Short packets',
    shortPacketsNote: 'Twenty milliseconds of voice per packet instead of sixty. On a network that loses packets the voice holds better; it costs a little more battery. It holds for both phones.',
    ...
    shareJournal: 'Share the journal',
    shareJournalNote: 'The last three days\' files, yours and the other person\'s, wherever you like: mail, messages, a folder. Nothing of what you said to each other: battery, network, screen, and what the app was doing.',
    ...
    gitlabToken: 'GitLab token (optional)',
    gitlabTokenNote: 'A personal access token with the "api" scope. It stays on this phone; you can revoke it whenever you like.',
    gitlabTokenMake: 'Create the token on GitLab',
    sendJournal: 'Send the journal to my work item',
    reportProblem: 'Report a problem',
    reportPlaceholder: 'What happened, when, what you expected…',
    reportAttach: 'Attach the journal',
    reportAttachNote: 'The last three days, yours and the other person\'s.',
    reportSend: 'Send',
  ...
  welcome: {
    ...
    serverBody: 'Duetto runs on a server of your own, or of somebody who let you in. Write its name, or paste the invitation link you were sent; or point the camera at the QR code the other phone shows you: the server comes with it.',
    serverOrLink: 'Server, or an invitation link',
    acceptTitle: 'Accept an invitation or a connection',
    acceptBody: 'Somebody handed you something: point the camera at their QR code, paste the link, or write what they read out. Duetto tells an invitation from a connection by itself.',
    acceptField: 'Code, invitation or link',
    acceptPlaceholder: '1234 5678, ABCD-2345, or https://…',
    acceptHint: 'Eight digits are a connection; four letters, a dash and four more are an invitation to a server. A link does as it is: it carries the server with it.',
    acceptUnknown: 'That is neither a code, nor an invitation, nor a link of Duetto.',
    betaTitle: 'No server?',
    betaBody: 'Duetto is looking for beta testers: ask to take part and you will get an invitation, with the server inside. A GitLab page opens: put your name in the title, in place of the part in angle brackets, and submit. A GitLab account is needed, free of charge.',
    betaButton: 'Ask to be a beta tester',
    next: 'Next',
    back: 'Back',
  ...
  pairing: {
    ...
    connectBody: 'To be done once only. On one phone press "Create the code", on the other "Accept an invitation or a connection".',

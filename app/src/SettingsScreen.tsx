...
const styles = StyleSheet.create({
  ...
  // Room above: a title right under the box of the choice before it read as its caption.
  subsection: { color: '#c9d2de', fontWeight: '700', fontSize: 15, marginTop: 30 },
  secondary: {
  ...
  sectionHint: { color: '#6b7686', fontSize: 13, marginTop: 14, marginBottom: 12, lineHeight: 19 },
